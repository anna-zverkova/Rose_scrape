...
with open(filename,'w',newline='',encoding='utf-8') as f:
    ...
    # Printing rose data in Terminal
        ...
        w.writerow([(name.encode('ascii','ignore')).decode('utf-8'),url,(price.encode('ascii','ignore')).decode('utf-8'),_type_,name2,rating_scent,flower,cluster,height,text,reg_name])
